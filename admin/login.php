<?php
// Script de connexion avec base de données
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        $admin = $db->findOneBy('users', ['username' => $username, 'role' => 'admin']);
        
        if (!$admin) {
            // Essayer avec l'email
            $admin = $db->findOneBy('users', ['email' => $username, 'role' => 'admin']);
        }
...
<head>
    ...
    <title><?php echo $pageTitle; ?> - Espace Admin | Pro Alu et PVC</title>
